				...
				<div class='col-sm-9'>
                    ...
                    <table class='borderless' style="width:100%;">
                        ...
                        <tr>
                            ...
                            <td> : </td>
                            <td width="100px;"><span id='Bayaran'>Rp. 0.00</span></td>
                        </tr>
                        <tr>
                         ...
                         <input type='hidden' name='cash' id='UangCash'>
			...
			$.ajax({
				...
				success:function(response){
					...
					$.each(paymentType, function( key, value ) {
					 //console.log(  value.PaymentDescription + ": " + value.PaymentDescription );
...
function bayarBaru(){
	...
	var Baris = "<tr>";
		...
		Baris +="<td>";
		Baris += "<select name='type_pay[]' class='form-control input-sm payType_"+Nomor+"' style='cursor: pointer;' disabled>";
		...
		Baris += "<td>";
		Baris += "<input type='text' class='form-control nilai_bayar' id='nilai_bayar' name='nilai_bayar[]' onkeypress='return check_int(event)' disabled>";
		Baris += "<span></span>";
		Baris += "</td>";

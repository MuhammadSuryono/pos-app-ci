...
<table id="my-grid" class="table tabel-transaksi" style='margin-bottom: 0px; margin-top: 10px;'>
	...
	echo "	
		...
		<tr style='background:#deeffc;'>
			...
			<td><b>Rp. ".number_format(($data_order->TotalPembayaran - $totalbayar - $dv) * -1 ,2,',','.')."</b></td>
		</tr>";
	...
	echo '<td colspan="6" align="right">
			...
			<input type="text" id="PotonganPrint" value="'.str_replace(',', '.',number_format(($data_order->TotalPembayaran - $totalbayar - $dv) * -1)).'" />
